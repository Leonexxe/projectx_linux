...
public class Client {
    ...
    public Client(Storage storage, String os) throws IOException, InterruptedException {
        ...
        switch(os)
        {
            case("linux"):this.folderSeperator = "/";
            break;
            default:this.folderSeperator="\\";
        }
        ...
        // opening Json files
        this.jsonCrypto = new Json(this.storage.installPath.replace("\\", this.folderSeperator) + "ProjectX_Client"+this.folderSeperator+"src"+this.folderSeperator+"settings"+this.folderSeperator+"cryptography.json");
        this.jsonUserSettings = new Json(this.storage.installPath.replace("\\", this.folderSeperator) + "ProjectX_Client"+this.folderSeperator+"src"+this.folderSeperator+"settings"+this.folderSeperator+"userSettings.json");
